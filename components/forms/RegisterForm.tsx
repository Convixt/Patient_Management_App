    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12 flex-1">
        ...
        <CustomFormField
          ...
          name="address"
          label="Address"
          placeholder="Eg. 13-B Mayur Vihar, New Delhi"
        ...
        <CustomFormField
          ...
          placeholder="Eg. Pollen , perfume , honey"
        ...
        <CustomFormField
          ...
          placeholder="Dolo 650mg , Paracetamol 500mg"
